...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                    ...
                    .antMatchers("/main_admin", "/index_admin", "/salony_admin", "/ofertaKupno_admin", "/ofertaWypozyczenie_admin", "/modele_admin", "/modele_add", "/kontakt_admin", "/salony_add").access("hasRole('ADMIN')")
